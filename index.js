...
const boardMember = new BoardMember("Alex", "California", "Business Management");

console.log(boardMember.sayHi()); // Hi, my name is Alex. I am from California, and I was trained in Business Management.
